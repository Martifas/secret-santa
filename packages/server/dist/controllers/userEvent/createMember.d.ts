    ...
    _ctx_out: {
        ...
        repos: {
            ...
            userEventRepository?: {
                ...
                create(record: import("kysely").Insertable<import("../../database").UserEvent>): Promise<UserEventForMember>;
                updateRole(id: number, updates: import("../../types/userEvent").UserEventRowUpdate): Promise<UserEventForMember>;
