    ...
    _ctx_out: {
        ...
        repos: {
            eventRepository?: {
                ...
                create(event: import("kysely").Insertable<import("../../database").Event>): Promise<EventForMember>;
                update(id: number, updates: import("../../types/event").EventRowUpdate): Promise<EventForMember>;
...
//# sourceMappingURL=removeEvent.d.ts.map