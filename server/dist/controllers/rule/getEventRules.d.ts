    ...
    _ctx_out: {
        ...
        repos: {
            ...
            ruleRepository?: {
                ...
                create(rule: import("kysely").Insertable<import("../../database").EventRule>): Promise<RuleForMember>;
                update(id: number, updates: import("../../types/rule").RuleRowUpdate): Promise<RuleForMember>;
...
//# sourceMappingURL=getEventRules.d.ts.map